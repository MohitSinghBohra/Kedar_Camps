      ...
      <div style={{ maxWidth: 1140, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: 40, marginBottom: 40 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.8 }}>Kedarnath, Rudraprayag<br />Uttarakhand — 246 445<br />Near Kedarnath Base Camp</p>
          </div>
          <div>
            <p style={{ color: '#a7f3d0', fontWeight: 600, marginBottom: 12, fontSize: 13, letterSpacing: 1, textTransform: 'uppercase' }}>Season</p>
            <p style={{ fontSize: 13, lineHeight: 1.8 }}>Open: April – Nov<br />Best time: June &amp; October<br />Altitude: 3,583m above sea level</p>
          </div>
          <div>
            <p style={{ color: '#a7f3d0', fontWeight: 600, marginBottom: 12, fontSize: 13, letterSpacing: 1, textTransform: 'uppercase' }}>Contact</p>
            <p style={{ fontSize: 13, lineHeight: 1.8 }}>📞 +91 96347 82733<br />✉ hello@kedarcamps.in<br />Payment collected at camp</p>
          </div>
        </div>
